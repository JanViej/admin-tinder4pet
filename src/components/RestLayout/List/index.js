...
const RestListComponent = (props) => {
  ...
  const actions = (
    <div className="vActions">
      ...
      {hasCreate &&
        ...
        (CustomCreateButton ? (
          <CustomCreateButton gotoCreatePage={gotoCreatePage} />
        ) : (
          <CreateButton
            header={createHeader}
            resource={resource}
  ...
  const paginationBottomView = (
    <Row
      ...
      type="flex"
    >
      {isShowPagination && resourceFilter.count > 0 && (
    ...
    <ListWrapper>
      <div className="viewContent">
        {!noCardWrapper && (
          ...
          >
            <CustomBreadcrumb size={24} data={breadCrumbs || BREADCRUMB_LIST} />
            {headerDesc && (
              <div className="desc-header">{I18n.t(headerDesc)}</div>
            )}
          </PageTitle>
        )}
...
RestListComponent.propTypes = {
  ...
  CustomCreateButton: PropTypes.node,
  ExtraHeaderActions: PropTypes.node,
  hasCreateHeaderButton: PropTypes.bool,
